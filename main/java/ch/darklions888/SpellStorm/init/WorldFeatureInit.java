...
public class WorldFeatureInit {
	public static void init() {
		registerOreConfig(3, 8, 5, 20, BlockInit.CRYSTAL_ORE.get());
	}
	
	public static void setup() {
		addOreToGenerate(BlockInit.CRYSTAL_ORE.get());
		addMagicalTree();
	}


	private static void registerOreConfig(int veinCount, int veinSize, int minY, int maxY, Block ore) {
