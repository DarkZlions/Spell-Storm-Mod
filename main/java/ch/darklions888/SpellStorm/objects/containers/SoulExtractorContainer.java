...
public class SoulExtractorContainer extends Container 
{
	...
	private void updateOutput()
	{
		try {
			...
			if(catchStack.getItem() instanceof SoulCatcherItem && containerStack.getItem() instanceof IMagicalContainer)
			{
				...
				{				
					...
					{
						containerItem.addManaValue(containerCopy, getSourceFromEntity(mob).sourceId, (int) mob.getMaxHealth());		
