...
public class ItemColorHandler {
	...
	public static ItemColors init(ItemColors colorsIn) {
		...
		colorsIn.register((itemStack, color) -> {
			return color == 0 ? itemStack.getItem() instanceof BaseSwordItem ? MagicSource.getMagicSourceColour(((BaseSwordItem)itemStack.getItem()).getMagicSourceList(null).get(0)) : 0xFFFFF : -1;
