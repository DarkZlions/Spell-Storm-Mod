...
public class BlockInit  {
	...
	public static final RegistryObject<Block> CRYSTAL_ORE = REGISTER_BLOCKS.register("crystal_ore", () -> new CrystalOreBlock(Block.Properties.create(Material.ROCK, DyeColor.PURPLE).func_235861_h_().hardnessAndResistance(3.0f, 6.0f).harvestLevel(3).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE)));
	public static final RegistryObject<Block> CORRUPTED_CRYSTAL_ORE = REGISTER_BLOCKS.register("corrupted_crystal_ore", () -> new CrystalOreBlock(Block.Properties.create(Material.ROCK, DyeColor.PURPLE).func_235861_h_().hardnessAndResistance(4.0f, 7.0f).harvestLevel(4).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE)));
	...
	public static final RegistryObject<Block> MAGICAL_FORGE = REGISTER_BLOCKS.register("magical_forge", () -> new MagicalForgeBlock(Block.Properties.create(Material.ANVIL, DyeColor.BLACK).func_235861_h_().hardnessAndResistance(3.0f, 6.0f).harvestLevel(2).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE)));
}
