...
public class EntityInit {
	...
	public static final RegistryObject<EntityType<MagicalFireballEntity>> MAGICAL_FIREBALL = REGISTER_ENTITY.register(Lib.RegistryNames.MAGICAL_FIREBALL_ENTITY_STR, () -> EntityType.Builder.<MagicalFireballEntity>create(MagicalFireballEntity::new, EntityClassification.MISC).size(0.3125F, 0.3125F).setTrackingRange(64).setUpdateInterval(1).setShouldReceiveVelocityUpdates(true).build(Lib.RegistryNames.MAGICAL_FIREBALL_ENTITY_RS.toString()));
