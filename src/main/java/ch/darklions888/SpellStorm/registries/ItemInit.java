...
public class ItemInit {
	...
	public static final RegistryObject<Item> MAGICAL_WOOD_LOG = REGISTER_ITEMS.register("magical_wood_log", () -> new BaseBlockItem(MagicSource.NEUTRALMAGIC, ManaPower.LOW, null, false, BlockInit.MAGICAL_WOOD_LOG.get(), 200, new Item.Properties().group(TAB)));
	...
	public static final RegistryObject<Item> MAGICAL_LEAVES = REGISTER_ITEMS.register("magical_leaves", () -> new BaseBlockItem(MagicSource.NEUTRALMAGIC, ManaPower.LOW, null, false, BlockInit.MAGICAL_LEAVES.get(), 220, new Item.Properties().group(TAB)));
	...
	public static final RegistryObject<Item> GATEWAY_BLOCK = REGISTER_ITEMS.register("gateway", () -> new BaseBlockItem(MagicSource.UNKNOWNMAGIC, ManaPower.VERYHIGH, null, false, BlockInit.GATEWAY.get(), new Item.Properties().group(TAB)));
}
